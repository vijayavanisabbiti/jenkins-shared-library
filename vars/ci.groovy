        ...
        if (env.JOB_BASE_NAME ==~ "PR-.*") {
            ...
            stage('Release App') {
                ...
                wrap([$class: 'MaskPasswordsBuildWrapper', varPasswordPairs: [[password: "${ARTIFACTORY_PASSWORD}", var: 'PASSWORD']]]) {
                    ...
                    sh 'curl -sSf -u "admin:${ARTIFACTORY_PASSWORD}" -X PUT -T ${repo_name}-${TAG_NAME}.zip http://artifactory.vijayavanimanju.online:8081/artifactory/${repo_name}-${TAG_NAME}.zip'
